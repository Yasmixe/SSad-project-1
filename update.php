...
if (isset($_POST['submit'])) {
    ...
    $Password = encryptCesar($_POST['password'], $shift);
    $Username = encryptCesar($_POST['username'], $shift);
    ...
    if ($result_check_username['count'] > 0) {
        ...
        $indice = testpassword($_POST['password']);
        if ($indice > 90) {
            ...
            if ($stmt->rowCount() > 0) {
                $sql1 = "UPDATE messages SET sender = :uname WHERE sender = :utilisateur";
                $sql2 = "UPDATE messages SET receiver = :user WHERE receiver = :utiliDechiffrer";
                ...
                $stmt2->bindParam(':utiliDechiffrer', $utiliDechiffrer);
                $stmt2->execute();
...
ul{
  ...
  .logout_btn{
    ...
    <li><a href= "../admin/user.php">Users </a></li>
      ...
      <li><a href="" class="logout_btn">log out </a></li>
    </ul>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"
                    placeholder="<?php  echo DechiffrementUser($utilisateur);?>" name="username"  autocomplete="off" required >
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"
                    placeholder="<?php  echo DechiffrementUser($motdepasse);?>" name="password"  autocomplete="off"  required>
            ...
            <button type="submit" class="btn btn-primary" name="submit"><a href="user.php">Cancel</a></button>
        </form>
    </div>
</body>
            <script>
